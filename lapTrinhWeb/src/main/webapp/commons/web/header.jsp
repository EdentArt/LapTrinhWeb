				...
				<ul class="list-unstyled list-inline pull-right">
					...
					<li><c:choose>
							<c:when test="${sessionScope.account == null}">
								<a herf="${pageContext.request.contextPath }/login">login</a>
								| <a herf="${pageContext.request.contextPath }/register">Register
								</a>
							</c:when>
							<c:otherwise>
								<a herf="${pageContext.request.contextPath }/member/myaccount">${sessionScope.account.fullname}</a>
								| <a herf="${pageContext.request.contextPath }/logout">Logout
								</a>
							</c:otherwise>
						</c:choose></li>
				</ul>
